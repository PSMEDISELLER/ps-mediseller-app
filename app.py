...
if selected_menu == "📍 নতুন লোকেশন এড":
    ...
    if all_parties_list:
        selected_order_party_native = st.selectbox(
            "🔍 পার্টি খুঁজুন ও সিলেক্ট করুন (টাইপ করলেই নাম নিচে দেখতে পাবেন):",
            options=["-- সিলেক্ট করুন --"] + all_parties_list,
            index=0,
            key="order_party_selectbox"
        )
    else:
        selected_order_party_native = "-- সিলেক্ট করুন --"
        st.warning("কোনো পার্টি সেভ করা নেই। প্রথমে উপরে নতুন পার্টি এন্ট্রি করুন।")
...
# =========================================================
    ...
    all_parties = list(party_coords.keys())

    with st.form("easy_assign_form", clear_on_submit=True):
        st.write("🔍 **পার্টি নির্বাচন করুন:**")
        
        if all_parties:
            sel_pt = st.selectbox("পার্টি সার্চ করুন (নাম লিখলেই অপশন দেখাবে):", ["-- সিলেক্ট করুন --"] + all_parties, key="task_party_selectbox")
        else:
            sel_pt = "-- সিলেক্ট করুন --"
