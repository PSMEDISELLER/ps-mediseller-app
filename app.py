...
if selected_menu == "Add Location (লোকেশন যোগ)":
        ...
        if st.session_state.get("user_role") == "admin":
            with st.expander("🛠️ Admin: Add Route (রুট সেট করুন)"):
                        ...
                        if existing_check:
                            ...
                            try:
                                ...
                                c.execute(
                                    ...
                                    (p_name.strip(), p_addr, p_phone.strip(), st.session_state["selected_lat"], st.session_state["selected_lon"], final_route),
                                )
                                c.execute(
